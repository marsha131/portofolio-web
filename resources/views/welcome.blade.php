...
<head>
    ...
    <style>
        ...
        .avatar-model {
            ...
            --progress-bar-color: #f43f5e;
            --progress-mask: transparent;
            pointer-events: auto;
        }
        .avatar-model::part(default-progress-bar) {
            height: 3px;
            border-radius: 999px;
        }
        .avatar-gloss {
                        ...
                        <div class="p-6 rounded-3xl border border-slate-100 bg-slate-50/50">
                            ...
                            <ul class="space-y-4 text-sm text-slate-600">
                                ...
                                <li>
                                    ...
                                    <span class="text-xs">Dep. Kerumahtanggaan (2025 - Sekarang)</span>
                                </li>
                            </ul>
                        </div>
...
<body class="text-slate-800 antialiased min-h-screen flex flex-col transition-colors duration-300">
                        ...
                        <div class="p-6 rounded-3xl border border-slate-100 bg-slate-50 flex flex-col">
                            ...
                            <ul class="space-y-4 text-sm text-slate-600">
                                <li>
                                    ...
                                    <span class="text-xs">Div. Kesehatan (2026) & LO (2025)</span>
                                </li>
                                <li>
                                    <span class="text-primary font-bold block leading-tight transition-colors">MMB Fest & PKKMB</span>
                                    <span class="text-xs">Div. Konsumsi (2025) & Siaga (2025)</span>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <script>
        ...
        // --- INTERAKTIF AI CHATBOT (LOGIKA ASLI MARSHA) ---
        function toggleAI() { document.getElementById('aiChat').classList.toggle('hidden'); }
